...
# print('Top-k result = ', topk_result)
# print('Evaluation Count = ', full_evaluation_count)
# result = [(10, 1), (10, 13), (8, 3), (2, 4), (2, 3), (2, 2)]
# result = sorted(result, key=lambda i: (-i[0], i[1]))
# print(result)

# a = {'The': [(1, 2)], 'a': [(1, 4), (3, 2), (4, 2), (6, 2), (8, 2), (10, 2), (13, 2), (14, 2), (15, 2), (19, 2), (20, 2)], 'the': [(2, 4), (3, 4), (4, 2), (5, 4), (6, 2), (7, 2), (8, 2), (9, 4), (11, 4), (12, 2), (13, 4), (14, 2), (15, 2), (17, 2), (18, 4), (19, 2)]}
# c, b = a['The'][0]
# if len(a['The'])-1 >= a['The'].index((c, b)) + 1:
#     m, n = a['The'][a['The'].index((c, b)) + 1]
#     u = [m, n]
# else:
#     u = []
#
...
# b = [['is', []], ['a', []], ['The', []]]
#
# def new_candidates(candidate_pairs):
#     new_candidate = []
...
#
# def check_null(candidate_pairs):
#     a = 0
#     for i in range(len(candidate_pairs)):
